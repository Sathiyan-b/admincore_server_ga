...
import { grahamScan, melkman } from "../../shared/libs/convex-hull";
...
@Component({
  selector: "alarm-fabric-js-component",
  templateUrl: "./fabric-js.alarm.component.html",
  styleUrls: ["./fabric-js.alarm.component.css"],
})
export class FabricJSAlarmComponent implements OnInit {
