...
@Component({
  selector: "alarm-access-control",
  styleUrls: ["./access-control.alarm.component.css"],
  templateUrl: "./access-control.alarm.component.html",
})
export class AccessControlAlarmComponent implements OnInit {
  TabIndex = 1;
